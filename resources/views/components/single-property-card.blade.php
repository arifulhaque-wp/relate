<div class="flex-1 shadow-lg relative rounded-md mx-4 mb-8">
    <a href=""
        class="absolute top-3 left-3 w-9 h-9 leading-10 self-center text-base bg-black text-white bg-opacity-25 text-center hover:bg-blue-900 hover:text-white duration-200 rounded-full"><i
    ...
    <div class="p-3">
        ...
        <h3 class="text-2xl py-3">{{ number_format($property->price), '2' }} &#8378;</h3>
